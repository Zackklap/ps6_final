...
/*
 * Lambda.LLList.java
 * Zack Klappenbach and Sophie Marugg
 * Email: Zackklap@bu.edu
 * Email: sophiemarugg@icloud.com
...
/*
 * A class that implements our simple Lambda.List interface using a linked list.
...
public class LLList implements List {
    // Inner class for a node.  We use an inner class so that the Lambda.LLList
    ...
    // fields of the Lambda.LLList object
    private Node head;     // dummy head node
    private int length;    // # of items in the list
    
    /*
     * Constructs a Lambda.LLList object for a list that is initially empty.
     */
    public LLList() {
    ...
    /*
     * Constructs an Lambda.LLList object containing the items in the specified array
     */
    ...
    /*
     * private inner class for an iterator over an Lambda.LLList
     */
